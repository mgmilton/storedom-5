...
describe "ActiveRecord Obstacle Course" do
  let(:user)    { User.create(name: "Ilana") }
  ...
  let!(:order_1)  { Order.create(amount: 200, items: [item_1, item_1, item_2, item_3], user: user) }
  let!(:order_2)  { Order.create(amount: 300, items: [item_1, item_1, item_2, item_3], user: user) }
  let!(:order_3)  { Order.create(amount: 500, items: [item_2, item_3, item_4, item_5], user: user) }
  let!(:order_4)  { Order.create(amount: 501, items: [item_1, item_1, item_2, item_3], user: user) }
  let!(:order_5)  { Order.create(amount: 550, items: [item_1, item_5, item_4, item_7], user: user) }
  let!(:order_6)  { Order.create(amount: 580, items: [item_5, item_8, item_9, item_10], user: user) }
  let!(:order_7)  { Order.create(amount: 600, items: [item_1, item_5, item_7, item_9], user: user) }
  let!(:order_8)  { Order.create(amount: 700, items: [item_2, item_3, item_8, item_9], user: user) }
  let!(:order_9)  { Order.create(amount: 649, items: [item_3, item_4, item_8, item_10], user: user) }
  let!(:order_10) { Order.create(amount: 750, items: [item_1, item_5, item_4, item_7], user: user) }
  let!(:order_11) { Order.create(amount: 800, items: [item_5, item_4, item_7, item_9], user: user) }
  let!(:order_12) { Order.create(amount: 850, items: [item_1, item_3, item_7, item_10], user: user) }
  let!(:order_13) { Order.create(amount: 870, items: [item_2, item_3, item_4, item_7], user: user) }
  let!(:order_14) { Order.create(amount: 900, items: [item_3, item_5, item_8, item_9], user: user) }
  let!(:order_15) { Order.create(amount: 1000, items: [item_1, item_4, item_5, item_7], user: user) }
